...
#     texture_keys = list(keys.copy()[i] for i in [3,4,7,8,11])
    our_keys = list(keys.copy()[i] for i in [1,6,9,10,11])
...
#                              ph_range,cn_range]
    ...
    soil_parameters_names = ['SOC', 'PV', 'pH', 'CN','BD']
...
#     site_data_copy['SiteParameters']['SoilProfileParameters'][0][our_keys[1]]=ka5
    ...
    site_data_copy['SiteParameters']['SoilProfileParameters'][0][our_keys[4]][0]=float(bd)
...
#     KA5_value = '_KA5' + str(site_data_copy['SiteParameters']['SoilProfileParameters'][0][our_keys[1]])
    ...
    BD_value =  str(site_data_copy['SiteParameters']['SoilProfileParameters'][0][our_keys[4]][0])


    file_name = str(SOC_value)+'_'+str(PV_value)+'_'+str(ph_value)+'_'+str(CN_value)+'_'+str(BD_value)
